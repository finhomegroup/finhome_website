...
export interface InternationalTransferCardProps {
  fromAmount: string;
  toAmount: string;
  fromCurrency?: string;
  toCurrency?: string;
...
export const InternationalTransferCard: React.FC<InternationalTransferCardProps> = ({
  fromAmount,
  toAmount,
  fromCurrency = 'USD',
  toCurrency = 'VND',
  ...
  const fromSym = fromCurrencySymbol ?? '$';
  const toSym = toCurrencySymbol ?? '₫';
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex flex-col gap-1 flex-1">
            <div className="flex items-center justify-between gap-1">
              <p className="font-medium text-xs text-gray-700">{fromPropertyName}</p>
              <p className="font-medium text-xs text-gray-700 opacity-50">ID: {fromPropertyId}</p>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <h3 className="font-semibold text-base text-gray-700">
                  -{fromSym}{fromAmount}{' '}
                  <span className="text-gray-700 opacity-50">{fromCurrency}</span>
                </h3>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1 flex-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <h3 className="font-semibold text-base text-gray-700">
                  {toSym}{toAmount}{' '}
                  <span className="text-gray-700 opacity-50">{toCurrency}</span>
                </h3>
              </div>
            </div>
          </div>
...
export default InternationalTransferCard;
